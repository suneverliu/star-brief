...
```powershell
git clone https://github.com/suneverliu/star-exec-brief.git "$env:USERPROFILE\.codex\skills\star-brief"
```

If you use `CODEX_HOME`:

```powershell
git clone https://github.com/suneverliu/star-exec-brief.git "$env:CODEX_HOME\skills\star-brief"
```
